...
public class ShaderProgram {
    ...
    public int _colourOfLight = -1;
    public int _positionOfLight = -1;
    ...
    public void getVariableHandles() {
        ...
        _colourOfLight = GLES20.glGetUniformLocation(programHandle, "colourOfLight");
        _positionOfLight = GLES20.glGetUniformLocation(programHandle, "positionOfLight");
    }
